...
class DMSHN(nn.Module):
    ...
    def forward(self,images_lv1):
        ...
        images_lv2 = F.interpolate(images_lv1, scale_factor=0.5, mode='bilinear', align_corners=True, recompute_scale_factor=True)
        images_lv3 = F.interpolate(images_lv2, scale_factor=0.5, mode='bilinear', align_corners=True, recompute_scale_factor=True)

        feature_lv3 = self.encoder_lv3(images_lv3)
        residual_lv3 = self.decoder_lv3(feature_lv3)
        out_lv3 = images_lv3 + residual_lv3 

        residual_lv3 = F.interpolate(residual_lv3, scale_factor=2, mode= 'bilinear', align_corners=True, recompute_scale_factor=True)
        feature_lv3 = F.interpolate(feature_lv3, scale_factor=2, mode= 'bilinear', align_corners=True, recompute_scale_factor=True)
        ...
        residual_lv2 = F.interpolate(residual_lv2, scale_factor=2, mode= 'bilinear', align_corners=True, recompute_scale_factor=True) 
        feature_lv2 = F.interpolate(feature_lv2, scale_factor=2, mode= 'bilinear', align_corners=True, recompute_scale_factor=True)
